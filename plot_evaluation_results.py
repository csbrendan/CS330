...
data_gender = {
    ...
    "RGN CDA": [evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['LM Score'], 
                evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['SS Score'], 
                evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['ICAT Score']],                
...
data_race = {
    ...
    "RGN CDA": [evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['LM Score'], 
                evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['SS Score'], 
                evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['ICAT Score']],                
...
data_profession = {
    ...
    "RGN CDA": [evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['LM Score'], 
                evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['SS Score'], 
                evaluation_results['RGN_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['ICAT Score']],                
