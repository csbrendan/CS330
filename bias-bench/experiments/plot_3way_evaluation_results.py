...
data_gender = {
    ...
    "MLL_CDAGPT2": [evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['LM Score'], 
                evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['SS Score'], 
                evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['ICAT Score']],
    "LL_CDAGPT2": [evaluation_results['LL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['gender']['LM Score'], 
...
data_race = {
    "Metric": ["LM Score", "SS Score", "ICAT Score"],
    "MLL_CDAGPT2": [evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['LM Score'], 
                evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['SS Score'], 
                evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['ICAT Score']],
    "LL_CDAGPT2": [evaluation_results['LL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['race']['LM Score'], 
...
# Now df_race_corrected is ready for plotting


# Extract and process data for profession comparison
data_profession = {
    "Metric": ["LM Score", "SS Score", "ICAT Score"],
    "MLL_CDAGPT2": [evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['LM Score'], 
                evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['SS Score'], 
                evaluation_results['MLL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['ICAT Score']],
    "LL_CDAGPT2": [evaluation_results['LL_stereoset_m-CDAGPT2LMHeadModel_c-gpt2_s-42']['intrasentence']['profession']['LM Score'], 
